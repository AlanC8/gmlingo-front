    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-1 p-6 flex flex-col justify-center items-center space-y-8">
        ...
        <div className="flex space-x-6">
          <button onClick={() => router.push('/invest/stocks')} className="bg-[#FF5E6A] text-white py-4 px-8 rounded-lg text-xl shadow-lg hover:bg-red-600 transition duration-300 transform hover:scale-105">
