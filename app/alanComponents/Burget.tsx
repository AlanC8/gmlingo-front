...
import { FaTimes, FaHome, FaStore, FaSmile, FaFire } from "react-icons/fa";
        ...
        >
          <div className="p-4 bg-[#E63946] text-white flex justify-between items-center">
            <div className="flex items-center">
              <p className="ml-2 text-lg font-bold">Меню</p>
            </div>
          ...
          <div className="p-4">
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <button onClick={() => router.push('/gemini')} className="text-gray-700 flex items-center space-x-2">
                <span>Ваш Уоррен Баффет</span>
                <FaFire className="ml-auto" />
              </button>
